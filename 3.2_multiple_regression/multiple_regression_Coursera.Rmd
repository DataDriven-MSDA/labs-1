...
<div id="exercise">
**Exercise:** Write out the equation for the linear model and interpret the slope. 
</div>
...
<div id="exercise">
**Exercise:** Is `bty_avg` still a significant predictor of `score`?  Has the 
addition of `gender` to the model changed the parameter estimate for `bty_avg`?
</div>
