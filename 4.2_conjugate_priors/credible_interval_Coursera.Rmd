...
<ol>
<li> Gamma($a = 22$, $b = 6$) **-CORRECT ANSWER **
<li> Gamma($a = 18$, $b = 5$)
<li> Gamma($a = 18$, $b = 6$)
<li> Gamma($a = 19$, $b = 8$)
</ol>
...
<li> Gamma($a = 8119$, $b = 5001$) **-CORRECT ANSWER ** </li>
