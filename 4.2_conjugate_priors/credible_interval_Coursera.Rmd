...
<li> The probability that the true proportion of females lies in this interval is 0.95. **- CORRECT ANSWER**</li>
...
<ol>
<li> approximately 0.03 **- CORRECT ANSWER**</li>
...
In summary, when we used a prior distribution that was centered around a realistic value for $p$ (0.5), the credible interval we obtained was also realistic. However when we used a prior distribution that was centered around a clearly unrealistic value for $p$, the credible interval we obtained was also equally unrealistic. Hence, a good prior helps, however a bad prior can hurt your results. 
...
<ol>
<li> $Gamma(a = 1, b = 5)$ </li>
<li> $Gamma(a = 5, b = 1)$ **- CORRECT ANSWER**</li>
...
<ol>
<li> (1.594, 1.653) **- CORRECT ANSWER**</li> 
<li> **some other choices**
</ol>
