...
As with any new data set a good place to start is standard exploratory data analysis. We will begin witht the `wage` variable since it will be the response variable in our models.
